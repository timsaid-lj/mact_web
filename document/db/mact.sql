/*
MySQL Backup
Database: smart_javamg
Backup Time: 2019-05-24 18:14:25
*/

SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS `smart_javamg`.`gen_scheme`;
DROP TABLE IF EXISTS `smart_javamg`.`gen_table`;
DROP TABLE IF EXISTS `smart_javamg`.`gen_table_column`;
DROP TABLE IF EXISTS `smart_javamg`.`gen_template`;
DROP TABLE IF EXISTS `smart_javamg`.`mact_user`;
DROP TABLE IF EXISTS `smart_javamg`.`sys_area`;
DROP TABLE IF EXISTS `smart_javamg`.`sys_dict`;
DROP TABLE IF EXISTS `smart_javamg`.`sys_log`;
DROP TABLE IF EXISTS `smart_javamg`.`sys_menu`;
DROP TABLE IF EXISTS `smart_javamg`.`sys_role`;
DROP TABLE IF EXISTS `smart_javamg`.`sys_role_menu`;
DROP TABLE IF EXISTS `smart_javamg`.`sys_user`;
DROP TABLE IF EXISTS `smart_javamg`.`sys_user_role`;
