		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<%--<c:if test="${cookie.theme.value eq 'cerulean'}"> --%>
					...
					<div id="" style="background:url(${ctxStatic}/images/logo-icon.png) right repeat-x;width:100%;">
						<div style="background:url(${ctxStatic}/images/logo-icon.png) left no-repeat;width:100%;height:70px;"></div>
					</div>
					<script type="text/javascript">
