...
<head>
	...
	<style type="text/css">
      ...
      body{background:url(${ctxStatic}/images/background.png) no-repeat center center;}
    </style>
...
<body>
	...
	<div class="footer">
		Copyright &copy; ${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By javamg ${fns:getConfig('version')}
	</div>
